...
default:
	@echo Use the appropriate platform specific Makefile: Makefile.SAM3X8_DUE, Makefile.STM32F4, Makefile.STM32F4_POG, Makefile.STM32F4_EDA, Makefile.STM32F4_DVMV1.
