...
* Makefile.STM32F4_DVMV1 - This makefile is used for targeting the official DVMProject DVM-V1 modem boards ([https://store.w3axl.com](https://store.w3axl.com/products/dvm-v1-duplex-modem))
