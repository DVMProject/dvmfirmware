...
namespace sdr
{
    namespace port
    {
         ...
         * @ingroup port
         */
        class DSP_FW_API UARTPort : public ISerialPort {
        public:
            /**
             ...
             * @param assertRTS 
             */
            UARTPort(const std::string& device, UART_SERIAL_SPEED speed, bool assertRTS = false, bool rtsBoot = false);
            /**
        ...
        protected:
             ...
             * @param assertRTS 
             */
            UARTPort(UART_SERIAL_SPEED speed, bool assertRTS = false, bool rtsBoot = false);

            bool m_isOpen;

            std::string m_device;
            UART_SERIAL_SPEED m_speed;
            bool m_assertRTS;
            bool m_rtsBoot;
#if defined(_WIN32)
            HANDLE m_fd;
