...
extern DSP_FW_API bool LogInitialise(const std::string& filePath, const std::string& fileRoot, uint32_t fileLevel, uint32_t displayLevel, bool disableTimeDisplay = false);
...
extern DSP_FW_API void Log(uint32_t level, const char* module, const char* fmt, ...);
