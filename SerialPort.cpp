        ...
        if (m_ptr == 0U) {
            ...
            if (m_ptr == m_len) {
                ...
                case CMD_DMR_START:
                    ...
                    if (err != RSN_OK) {
                        DEBUG3("Received invalid DMR start", err, m_len);
                        sendNAK(err);
                    }
                    break;
                ...
                case CMD_P25_DATA:
                    ...
                    if (err == RSN_OK) {
                        ...
                        DEBUG2("Received invalid P25 data", err);
                        sendNAK(err);
                    }
                    break;
...
void SerialPort::setMode(DVM_STATE modemState)
{
    ...
    case STATE_DMR_CAL:
        ...
        break;
    case STATE_P25_CAL:
        DEBUG1("Mode set to P25 Calibrate");
        dmrIdleRX.reset();
        dmrDMORX.reset();
        dmrRX.reset();
        p25RX.reset();
    ...
    case STATE_RSSI_CAL:
        ...
        break;
    case STATE_LF_CAL:
        DEBUG1("Mode set to 80Hz Calibrate");
        dmrIdleRX.reset();
        dmrDMORX.reset();
        dmrRX.reset();
        p25RX.reset();
    ...
    case STATE_DMR_CAL_1K:
        DEBUG1("Mode set to DMR BS 1031Hz Calibrate");
        dmrIdleRX.reset();
        dmrDMORX.reset();
        dmrRX.reset();
        p25RX.reset();
    ...
    case STATE_DMR_DMO_CAL_1K:
        DEBUG1("Mode set to DMR MS 1031Hz Calibrate");
        dmrIdleRX.reset();
        dmrDMORX.reset();
        dmrRX.reset();
        p25RX.reset();
    ...
    case STATE_P25_CAL_1K:
        DEBUG1("Mode set to P25 1011Hz Calibrate");
        dmrIdleRX.reset();
        dmrDMORX.reset();
        dmrRX.reset();
        p25RX.reset();
