...
namespace sdr
{
    namespace port
    {
        ...
        public:
            ...
            UARTPort(const std::string& device, SERIAL_SPEEDS speed, bool assertRTS = false);
        ...
        protected:
            /// <summary>Initializes a new instance of the UARTPort class.</summary>
            UARTPort(SERIAL_SPEEDS speed, bool assertRTS = false);

            bool m_isOpen;

            std::string m_device;
            SERIAL_SPEEDS m_speed;
            bool m_assertRTS;
            int m_fd;
            ...
            /// <summary></summary>
            bool setTermios();
        }; // class DSP_SW_API UARTPort : public ISerialPort, public IModemPort
    } // namespace port
} // namespace sdr
